...
@Configuration
	...
	private final String[] FIELDS_NAMES = new String[] {"id","city","date","player_of_match","venue",
	  ...
	  public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
	    return new JdbcBatchItemWriterBuilder<Match>()
	      ...
	      + "VALUES (:id, :city, :date, :playerOfMatch, :venue, :team1, :team2, :tossWinner, :tossDecision, :tossWinner, :result, :resultMargin, :umpire1, :umpire2)").dataSource(dataSource)
	      .build();
	  }
